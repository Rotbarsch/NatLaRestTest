...
Background:
	...
	When the value '200' is stored in variable 'expectedResponseCode'
...
Scenario: Basic functionality
	...
	And the response code equals '$(expectedResponseCode)'
	...
	And the response code does not equal '$(expectedResponseCode)'
