using Bogus;
using NatLaRestTest.Bindings.Bindings.Actions.SetVariableActions;
...
/// <summary>
/// Driver that generates random numbers and strings using <see cref="Bogus"/>.
/// </summary>
public class RandomDataDriver : IRandomDataDriver
{
