...
/// </summary>
[Binding]
public class StringOperationBindings
{
    private readonly IVariableDriver _variableDriver;

    /// <summary>
    /// Initializes a new instance of the <see cref="StringOperationBindings"/> class.
    /// </summary>
    /// <param name="variableDriver">The variable driver used to store values.</param>
    public StringOperationBindings(IVariableDriver variableDriver)
    {
    ...
    public void GetSubString(int startIndex, int length, string input, string targetVariableName)
    {
        ...
        _variableDriver.SetVariable(targetVariableName, substring);
    }
    ...
    public void GetStringLength(string input, string targetVariableName)
    {
        ...
        _variableDriver.SetVariable(targetVariableName, stringLength.ToString());
    }
}